...
namespace dyno {
	...
	public:
		...
		**/
        virtual bool mem_copy(uintptr_t dest, uintptr_t src, uintptr_t size) const;
		...
		**/
        virtual bool safe_mem_write(uintptr_t dest, uintptr_t src, uintptr_t size, size_t& written) const noexcept;
		 ...
		 * Must fail gracefully
		**/
        virtual bool safe_mem_read(uintptr_t src, uintptr_t dest, uintptr_t size, size_t& read) const noexcept;

		virtual ProtFlag mem_protect(uintptr_t dest, uintptr_t size, ProtFlag newProtection, bool& status) const;
